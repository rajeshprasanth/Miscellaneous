...
wget $LOCAL_PSEUDO $NETWORK_PSEUDO/$PBE_PSEUDO_1 
wget $LOCAL_PSEUDO $NETWORK_PSEUDO/$PBE_PSEUDO_2 
wget $LOCAL_PSEUDO $NETWORK_PSEUDO/$PW_PSEUDO_1
wget $LOCAL_PSEUDO $NETWORK_PSEUDO/$PW_PSEUDO_2 
